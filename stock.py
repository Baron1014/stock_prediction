...
def main(model_id=None, model=None):
    ...
    if float(low_price) < his_mean_price:
        ...
        elif 0.03 < rate <= 0.04: vol = int(his_shares*discount)*4
        elif 0.04 < rate <= 0.05: vol = int(his_shares*discount)*5
        elif 0.05 < rate <= 0.06: vol = int(his_shares*discount)*6
        elif 0.06 < rate <= 0.07: vol = int(his_shares*discount)*7
        elif 0.07 < rate <= 0.08: vol = int(his_shares*discount)*8
        elif 0.08 < rate <= 0.09: vol = int(his_shares*discount)*9
        else: vol = int(his_shares*discount)*10
